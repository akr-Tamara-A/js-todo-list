...
function App() {
  return (
    <div className="page__content">
      ...
      <Section>
        <Form>
          <Input placeholder="Следующее дело..." />
          <Button className="todos__submit-btn" text="Добавить" />
        </Form>
        <TodoList>
          <TodoItem>
            <Button className="todo__btn todo__btn_type_edit">
              <svg
                width="24"
                height="23"
                viewBox="0 0 24 23"
            ...
            <Button className="todo__btn todo__btn_type_duplicate">
              <svg
                width="25"
                height="25"
                viewBox="0 0 25 25"
            ...
            <Button className="todo__btn todo__btn_type_delete">
              <svg
                width="18"
                height="17"
                viewBox="0 0 18 17"
